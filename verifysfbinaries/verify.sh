...
WORKINGDIR="/tmp/Kredit"
TMPFILE="hashes.tmp"

#this URL is used if a version number is not specified as an argument to the script
SIGNATUREFILE="http://downloads.sourceforge.net/project/Kredit/Kredit/Kredit-0.8.6/SHA256SUMS.asc"

SIGNATUREFILENAME="SHA256SUMS.asc"
RCSUBDIR="test/"
BASEDIR="http://downloads.sourceforge.net/project/Kredit/Kredit/"
VERSIONPREFIX="Kredit-"
RCVERSIONSTRING="rc"
...
if [ -n "$1" ]; then
   #let's also check if the version number includes the prefix 'Kredit-',
...
if [ $? -ne 0 ]; then
   ...
   echo "[Kredit-]<version>-[rc[0-9]] (example: Kredit-0.7.1-rc1)"
   echo "wget output:"
